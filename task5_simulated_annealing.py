def find_most_bishops_and_knights_with_queens_simulated_annealing(m, n, QueensPos):
    pass
...
def find_most_bishops_and_knights(m, n):
    return find_most_bishops_and_knights_simulated_annealing(m, n, alpha=30, beta=60)
